...
public class TreeSetManipuation {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("Elements less than 'B': " + treeSet.headSet("B")); // A will get printed only less than B
        
        // Use the tailSet() method to get the elements in the set that are greater than or equal to B.
	    System.out.println("Elements greater or equal to 'B': " + treeSet.tailSet("B"));
       ...
       System.out.println("Set after removing 'B: "+ treeSet.contains("B"));

        // Use remove() method to remove B from the set.
        treeSet.remove("B"); 

        // Print the set to show that the element B has been removed.
        System.out.println("Set after moving 'B': " + treeSet);
